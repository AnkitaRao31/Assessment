...
target_expiry_date = "2024-11-28"  # Replace with your specific date in "YYYY-MM-DD" format
...
nifty_expiry_data = extract_by_expiry(nifty_data, target_expiry_date)
hdfc_expiry_data = extract_by_expiry(hdfc_data, target_expiry_date)

# Display the extracted data
print("NIFTY Option Chain Data for Expiry Date:", target_expiry_date)
print(nifty_expiry_data)

print("\nHDFCBANK Option Chain Data for Expiry Date:", target_expiry_date)
